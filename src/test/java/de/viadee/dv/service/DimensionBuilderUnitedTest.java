...
/**
 * Tests the creation of united {@link Dimension}s (one Dimension for all {@link Satellite} of a {@link Hub}) <i>without
 * history</i>
 * 
 * @author B01
 *
 */
public class DimensionBuilderUnitedTest extends AbstractIntegrationTest {
