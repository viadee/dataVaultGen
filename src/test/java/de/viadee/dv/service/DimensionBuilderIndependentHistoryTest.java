...
/**
 * Tests the creation of independent dimensions (one {@link Dimension} for each {@link Hub}) <i>with history</i>
 * 
 * @author B01
 *
 */
public class DimensionBuilderIndependentHistoryTest extends AbstractIntegrationTest {
    ...
    public void testGeneratedViewDimKndAddress() {
        int rowcount = jdbcTemplate.queryForObject("SELECT count(VALID_FROM) FROM " + targetSchemaName
                + " .DIM_KND_ADDRESS", Integer.class);
